...
StudioView.STUDIO_API = 'https://projects.tutelmod.com/api/v1';

// The URL to download thumbnails from.
// $id is replaced with the project's ID.
StudioView.THUMBNAIL_SRC = 'https://projects.tutelmod.com/api/v1/projects/getproject?projectID=$id&requestType=thumbnail';

// The URL for project pages.
// $id is replaced with the project ID.
StudioView.PROJECT_PAGE = 'https://studio.tutelmod.com/#$id';
